...
def main(args):
    ...
    for it in range(max_iters):
        ...
        QT = args.samples_per_iter * args.qt_frac
        QT = int(QT)
        UNC = args.samples_per_iter - QT
        strat_idx = stratified_quantile_sampling(LOW_all, idx_unlabeled, QT, args.num_bins)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--qt_frac", type=float, required = True, default = 0.5)
    # 기존 인자들 ...
